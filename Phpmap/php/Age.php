...
$conn = pg_connect("dbname='Semester1' user='postgres' password='postgres' host='localhost:5433'");
if (!$conn) {
...
$sql = "SELECT rodenumber," . $_POST['adresse'] . ", st_asgeojson(st_transform(geom,4326)) AS geojson FROM agetable";
